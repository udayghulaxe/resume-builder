...
const ProfessionalSummary = (props) => {
	...
	return (
		...
		<div className="resume-section resume-section-professional-summary">
			...
			{
        openEditorName === props.componentItem.name ? <ProfessionalSummaryEditor setWidgetData={setWidgetData} open={open} setOpen={setOpen} componentColumn={props.componentColumn} componentName={props.componentItem.name} editorData={widgetData} />  : null
      }
		</div>
	);
};
