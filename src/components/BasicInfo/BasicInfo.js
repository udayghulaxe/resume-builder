                    ...
                    <Grid item xs={6}>
                        <Item>
                            ...
                            <Box component='span' sx={{ pl: 1 }}>
                                {props.componentItem.componentData.phone}
                            </Box>
                        </Item>
                    </Grid>
                    <Grid item xs={6}>
                        <Item>
                            ...
                            <Box component='span' sx={{ pl: 1 }}>
                                {props.componentItem.componentData.email}
                            </Box>
                        </Item>
                    </Grid>
                    <Grid item xs={6}>
                        <Item>
                            ...
                            <Box component='span' sx={{ pl: 1 }}>
                                {props.componentItem.componentData.website}
                            </Box>
                        </Item>
                    </Grid>
                    <Grid item xs={6}>
                        <Item>
                            ...
                            <Box component='span' sx={{ pl: 1 }}>
                                {props.componentItem.componentData.address}
                            </Box>
                        </Item>
                    </Grid>
                </Grid>
