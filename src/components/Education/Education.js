...
const Education = (props) => {
	...
	return (
		<div className="resume-section resume-section-education">
			...
			{
				openEditorName === props.componentItem.name ? <EducationEditor setWidgetData={setWidgetData} open={open} setOpen={setOpen} componentColumn={props.componentColumn} componentName={props.componentItem.name} editorData={widgetData} /> : null
			}
		</div>
	);
}
